...
- [x] **UX-04**: Arrow key navigation between email cards, Escape closes detail panel
- [x] **UX-05**: Loading skeleton shows in detail panel while HTMX fetches email content
